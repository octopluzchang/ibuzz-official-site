<template>
  <div>
        ...
        <div class="row justify-content-center">
          <div class="col-8">
            <h6 class="mb-0 text-center">
              i-Buzz商業應用報告(Business Applications Report)累積大數據分析十數年經驗，<br>
              將商業需求與疑難雜症歸類為六大面向，針對不同情境定義問題核心與數據解讀架構，<br>
              使用科學數據對症下藥，將客戶拉出困境。
            </h6>
          </div>
        </div>
    ...
    <div class="section">
      <div class="wrapper">
       <h2>獨家四大優勢特色！</h2>
       <h4 class="mb-5">為什麼i-Buzz是商業應用的首選？因為我們有…</h4>
        <div class="row  align-items-center">
          ...
          <div class="col">
            <div class="row">
              ...
              <img src="/assets/icons/icon_0-home-4.png" class="icon large">
               <h4>獨家專家分析模組</h4>
                <p>
                  i-Buzz以長達13年之網路大數據研究經驗，累積服務超過250個產業，並結合來自不同領域之專業人員，針對不同產業制定精準且符合現況之分類語詞庫，藉以萃取出最精確的數據！
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <img src="/assets/images/img_1-home-1.png">
          </div>
        </div>
      </div>
    </div>
    <div class="section dark">
      <div class="wrapper">
        <div class="row align-items-center">
         <div class="col">
           <img src="/assets/images/img_1-home-2.png">
         </div>
          <div class="col-lg-6">
           <h1>AI分析技術工具</h1>
            <h6>
              i-Buzz以兼具效率與精準度的五大獨家分析技術，打破傳統口碑研究僅以討論度與正負評分析為主之框架，透過多面向的嚴謹運算公式與語意判別，更深入洞悉產業與消費者。
            </h6>
          </div>
        </div>
        <div class="row">
          <div class="col-md col-sm-4 col-6">
           <img src="/assets/icons/icon_1-home-1.png" class="icon large">
            <h4>ID分析</h4>
            <p>透過語料線索與機器自動化學習，探索討論主題ID之人口結構與生活型態等分佈情況。</p>
          </div>
          <div class="col-md col-sm-4 col-6">
           <img src="/assets/icons/icon_1-home-2.png" class="icon large">
            <h4>類聚分析</h4>
            <p>依據文體與熱詞相似性，自動分類相關話題之討論主軸，快速歸納該主題重點面向為何。</p>
          </div>
          <div class="col-md col-sm-4 col-6">
           <img src="/assets/icons/icon_1-home-3.png" class="icon large">
            <h4>趨勢分析</h4>
            <p>計算關鍵詞與整體產業相對之變化量，找出可能潛在之產業趨勢變化。</p>
          </div>
          <div class="col-md col-sm-4 col-6">
           <img src="/assets/icons/icon_1-home-4.png" class="icon large">
            <h4>關聯分析</h4>
            <p>以指向性相關係數挖掘出與主題最相關之字詞，找出潛在對手與未被發現的消費者需求。</p>
          </div>
          <div class="col-md col-sm-4 col-6">
           <img src="/assets/icons/icon_1-home-5.png" class="icon large">
            <h4>情緒分析</h4>
